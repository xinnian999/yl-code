/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: ae40f3552058d84de3ab5f9ea2bde703)
// Runtime types generated with workerd@1.20260820.1 2026-08-21 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	UPSTREAM_BASE_URL: "https://code0.ai/v1";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_BASE_URL" | "BUILTIN_API_KEY">> {}
}
